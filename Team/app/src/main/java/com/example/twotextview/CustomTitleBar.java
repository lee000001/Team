package com.example.twotextview;
...
public class CustomTitleBar extends RelativeLayout {
    ...
    public CustomTitleBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.twotextview, this, true);
        ...
        if (attributes != null) {
            ...
            if (!TextUtils.isEmpty(leftButtonText)) {
                ...
                int leftButtonDrawable = attributes.getResourceId(R.styleable.CustomTitleBar_left_button_drawable, R.drawable.left);
