...
//        }
    ...
    public final static class FuncItem extends AbsContactItem {
        static final FuncItem VERIFY = new FuncItem();   //验证消息
//        static final FuncItem ROBOT = new FuncItem();    //机器人功能
        static final FuncItem NORMAL_TEAM = new FuncItem();    //讨论组功能
        static final FuncItem ADVANCED_TEAM = new FuncItem();  //群功能
        static final FuncItem BLACK_LIST = new FuncItem();     //黑名单功能
//        static final FuncItem MY_COMPUTER = new FuncItem();    //我的电脑功能
